  ...
  return (
		<>
			<div className="profile_button" onClick={openMenu}>
				<button className="nav_btn_profile">
					<i className="fa-solid fa-user" id="user_nav_btn"></i>
				</button>
				{showMenu && (
					<>
						<div className="profile_dropdown">
							...
							<div className="profile_image_div">
								<img
									className="profile_dropdown_img"
							...
							<div className="profile_name">
								<div>
									<h1 className="bold_text" id="dropdown_username">
